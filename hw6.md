...
### ⚙️ 設定選單
![遊戲設定](分鏡圖場景圖片/SettingMenu.png)
![遊戲設定](分鏡圖場景圖片/SettingMenu_2.png)
- 🎵Audio:這裡可以切換到音量設定
...
### 🔚遊戲結束畫面(分為通關和死亡)
![遊戲結束](分鏡圖場景圖片/GameOverMenu_Win.png)
![遊戲結束](分鏡圖場景圖片/GameOverMenu_Lose.png)
- 🔙Back Title:回到主畫面

### 遊戲會用到的關卡場景(目前共四間，進入關卡隨機一間)
![遊戲場景](分鏡圖場景圖片/room_1.png)
![遊戲場景](分鏡圖場景圖片/room_2.png)
![遊戲場景](分鏡圖場景圖片/room_3.png)
![遊戲場景](分鏡圖場景圖片/room_4.png)
